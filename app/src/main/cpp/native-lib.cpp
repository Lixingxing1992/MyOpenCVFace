...
Java_com_face_org_MainActivity_setSurface(JNIEnv *env, jobject instance,
                                                     jobject surface) {
    if (window) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_face_org_MainActivity_postData(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_face_org_MainActivity_init(JNIEnv *env, jobject instance, jstring model_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_face_org_MainActivity_release(JNIEnv *env, jobject instance) {
    if (tracker) {
        tracker->stop();
        delete tracker;
        tracker = 0;
